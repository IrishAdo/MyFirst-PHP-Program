...
<xsl:variable name="showhidden"><xsl:value-of select="//module[@name='sitemap']/show"/></xsl:variable>
	<xsl:choose>
		...
		<xsl:otherwise>
			...
			<h1 class="entrylocation" id="pageheader1"><span><xsl:choose>
