...
<xsl:template name="display_menu">
	<xsl:for-each select="//xml_document/modules/module[@name='layout']">
		<table border="0" cellspacing="0" cellpadding="0" summary="This table contains the menu" class="width100percent">
			<tr>
				<td class="darkblue"><img src="/libertas_images/themes/1x1.gif" alt="" width="25" height="1"/></td>
				<td class="lightblue"><img src="/libertas_images/themes/1x1.gif" alt="" width="135" height="1"/></td>
			</tr>
			...
			<tr>
				<td class="darkblue" ><img src="/libertas_images/themes/1x1.gif" width="25" alt="" height="1"/></td>
				<td class="lightblue" ><img src="/libertas_images/themes/1x1.gif" width="135" alt="" height="1"/></td>
			</tr>
		</table>
	</xsl:for-each>
</xsl:template>
