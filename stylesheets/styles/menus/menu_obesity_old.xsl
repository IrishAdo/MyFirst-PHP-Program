...
<xsl:template name="display_menu">
	...
	[[nbsp]]<br/>
      <table cellspacing="0" border="0" class="width100percent" summary="This table contains the menu"><xsl:call-template name="display_menu_parent">
...
<xsl:template name="display_menu_parent">
	...
	<xsl:for-each select="menu[@parent=$parent_identifier and @hidden='0']">
		<xsl:if test="position()=1 and @depth=1"><tr><td colspan="2" class="menubreaker"><img src="/libertas_images/themes/1x1.gif" height="5" alt=""/></td></tr></xsl:if>
