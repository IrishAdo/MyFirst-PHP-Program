...
function add_entry_first_level(label_str, url_str, alt_str){
	...
	"Arial","0.9em","<xsl:value-of select="$colour_text_first_level_off"/>","Normal","normal","none",
	"Arial","0.9em","<xsl:value-of select="$colour_text_first_level_on"/>","Normal","normal","none",
...
function add_entry(label_str, url_str, alt_str){
	...
	"","1","-1","-1","/libertas_images/themes/1x1.gif","/libertas_images/themes/1x1.gif","0","0","0",alt_str,url_str,"_self",
	"Arial","0.9em","<xsl:value-of select="$colour_text_off"/>","Normal","normal","none",
	"Arial","0.9em","<xsl:value-of select="$colour_text_on"/>","Normal","normal","none",
