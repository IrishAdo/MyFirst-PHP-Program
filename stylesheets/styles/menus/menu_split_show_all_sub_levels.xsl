...
<xsl:template name="display_menu">
	<xsl:for-each select="//xml_document/modules/module[@name='layout']">
       <table border="0" cellspacing="0" cellpadding="0" summary=""><xsl:call-template name="display_menu_parent">
...
<xsl:template name="display_submenu">
	...
	<table border="0" cellspacing="0" cellpadding="0" width="100%" summary="">
		...
		<tr>
			<td width="1" class="menutitlesplitterlight"><img src="/images/themes/1x1.gif" border="0" height="30" width="1"/></td>
			<td class="menutitle"><table border="0" cellspacing="0" cellpadding="5" width="100%" summary="">
		<tr>
			<td><img src="/images/themes/1x1.gif" border="0" height="25" width="10"/></td>
			<td class="menutitle"><xsl:call-template name="print"><xsl:with-param name="str_value"><xsl:copy-of select="label" /></xsl:with-param></xsl:call-template></td></tr></table></td>
			<td width="1" class="menutitlesplitterdark"><img src="/images/themes/1x1.gif" border="0" height="30" width="1"/></td>
		</tr>
