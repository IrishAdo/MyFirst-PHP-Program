...
- Modified $Date: 2004/10/05 11:03:46 $
-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
*/
-->
...
<xsl:template name="display_list">
	...
	<xsl:comment>display three columns title and summary.</xsl:comment>	<table cellpadding="5" cellspacing="5" border="0" width="100%" summary="This table contains a list of articles for this location">
		<tr>
		<td>
<xsl:choose>
		...
		<table cellspacing="0" cellpadding="0" width="100%" border="0" summary="A three column list of pages.">
			...
			</xsl:choose></xsl:with-param></xsl:call-template></td></tr></table></td>
