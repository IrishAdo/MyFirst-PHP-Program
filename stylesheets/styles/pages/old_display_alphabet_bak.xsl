...
<xsl:template name="display_list">
	...
	<xsl:variable name="end"><xsl:choose>
		<xsl:when test="(ceiling($page div 10)*10) > count(//xml_document/modules/module[@name='presentation']/page)"><xsl:value-of select="count(//xml_document/modules/module[@name='presentation']/page)"/></xsl:when>	
	...
	<xsl:call-template name="display_content_spanning">
		...
		<xsl:with-param name="max"><xsl:value-of select="count(//xml_document/modules/module[@name='presentation']/page)"/></xsl:with-param>
	...
	<xsl:call-template name="display_this_page">
		...
		<xsl:with-param name="identifier"><xsl:value-of select="//xml_document/modules/module[@name='presentation']/page[position()=$page]/@identifier"/></xsl:with-param>
	</xsl:call-template>
</xsl:template>
