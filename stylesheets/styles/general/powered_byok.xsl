			...
			<xsl:choose>
				<xsl:when test="//licence/product[@type='ECMS']">
					<div id='powerby' class="poweredbytext">
						Site managed by <a href="http://www.go-udo.com">U DO</a> from <a href="http://www.libertas-solutions.com">Libertas Solutions</a>
						</div>
				</xsl:when>
				<xsl:otherwise>
					<div id='powerby' class="poweredbytext">
						Site managed by <a href="http://www.go-udo.com">U DO</a>from <a href="http://www.libertas-solutions.com">Libertas Solutions</a><br/><a  href="http://www.libertas-solutions.com/" title="U DO Libertas Solutions  browser based Web Content Management Software"><xsl:if test="//setting[@name='powerby_in_new_window']='Yes'">
							<xsl:attribute name="rel">_libertasExternalWindow</xsl:attribute>
						</xsl:if>Web Content Management Software</a></div>
				</xsl:otherwise>
			</xsl:choose>
		</xsl:otherwise>
	</xsl:choose>
