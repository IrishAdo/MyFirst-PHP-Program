...
<div id="footerkeys">
	<ul class="accesskeys">
		<li><a accesskey="m" title="Toggle low graphics version [m]"><xsl:attribute name="href"><xsl:if test="//setting[@name='isbot']='0'">-/-toggle-text-only-mode.php</xsl:if></xsl:attribute><span class="icon"><span class="text">Switch to low graphics version</span></span></a></li>
		<xsl:choose>
...
<div><ul class="accesskeys" id="accesskeystop">
	...
	<script type="text/javascript" src="/libertas_images/javascripts/column.js"><xsl:comment>load sortable table</xsl:comment></script>				
</xsl:template>
...
<ul class="accesskeys" id="accesskeystop">
			...
			<li> <a accesskey="=" title="Increase the font size [=]" href="/-/-increase-font.php"><span class="icon"><span class="text">Font +</span></span></a> | </li>
<li> <a accesskey="-" title="Reduce the font size [-]" href="/-/-reduce-font.php"><span class="icon"><span class="text">Font -</span></span></a></li>
...
<ul class="accesskeys" id="accesskeystop">
			...
			<li> <a title="Skip to themain navigation for site"><xsl:attribute name="href"><xsl:value-of select="//setting[@name='real_url']"/>#menu</xsl:attribute><span class="icon"><span class="text">Skip to menu</span></span></a></li>
			<li> <a accesskey="m" title="Toggle between text only and graphical versions of site [m]" href="-/-toggle-text-only-mode.php"><span class="icon"><span class="text">Text only</span></span></a></li>
			<li> <a accesskey="=" title="Increase the font size [=]" href="/-/-increase-font.php"><span class="icon"><span class="text">Larger text</span></span></a></li>
<li> <a accesskey="-" title="Reduce the font size [-]" href="/-/-reduce-font.php"><span class="icon"><span class="text">Smaller text</span></span></a></li>
