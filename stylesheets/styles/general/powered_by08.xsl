	...
	<xsl:choose>
		...
		<xsl:otherwise>
			<xsl:choose>
				...
				<xsl:otherwise>
					<div id='powerby' class="poweredbytext">
						<a href="http://www.libertas-solutions.com" title="Web Design and CMS Development Northern Ireland">Web Design and CMS Development Northern Ireland</a><br><a href="http://www.go-udo.com">Content Management System</a><br/><a  href="http://www.go-udo.com" title="U DO Libertas Solutions  browser based Web Content Management Software"></div>
				</xsl:otherwise>
			</xsl:choose>
		</xsl:otherwise>
	</xsl:choose>
