...
<body>
	...
	<tr>
		<td valign="middle">
		<xsl:choose>
		<xsl:when test="//module/licence/product/@type='SITE'"><img width="250" height="80" alt="Libertas Site Wizard"><xsl:attribute name="src"><xsl:value-of select="$image_path"/>/admin_header.jpg</xsl:attribute></img></xsl:when>
		<xsl:when test="//module/licence/product/@type='MECM'"><img width="250" height="80" alt="Libertas Web Content Manager"><xsl:attribute name="src"><xsl:value-of select="$image_path"/>/admin_header.jpg</xsl:attribute></img></xsl:when>
		<xsl:when test="//module/licence/product/@type='ECMS'"><img width="250" height="80" alt="Libertas Enterprise Content Manager"><xsl:attribute name="src"><xsl:value-of select="$image_path"/>/admin_header.jpg</xsl:attribute></img></xsl:when>
		<xsl:otherwise><img width="250" height="80" alt="Libertas Solutions"><xsl:attribute name="src"><xsl:value-of select="$image_path"/>/admin_header.jpg</xsl:attribute></img></xsl:otherwise>
		</xsl:choose>
		</td>
		<td align="right">
