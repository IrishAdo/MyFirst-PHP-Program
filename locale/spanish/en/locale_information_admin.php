...
if (!defined("LOADED_INFODIR_ADMIN_LOCALE")){
	...
	define ("LOCALE_INFORMATIONADMIN_DATABASE"								, "Information Database");
	define ("LOCALE_INFODIR_STATUS"											, "Status of Information Directory");
	define ("LOCALE_INFODIR_DISPLAY_OPTIONS"								, "System Display options");
	...
	define ("LOCALE_INFODIR_HIDEEMPTYCAT"									, "Hide empty categories?");	
	define ("LOCALE_INFODIR_RESTRICT_TO_SUMMARY"							, "Restrict access to summary screen?");
	/*************************************************************************************************************************
    * 
    *************************************************************************************************************************/
	define ("LOCALE_DIRECTORY_LABEL"										,"Directory label");
	...
	define ("LOCALE_DIRECTORY_ECOMMERCE_ADD_LABEL_DEFAULT"					,"Add to basket");
	define ("LOCALE_DIRECTORY_ECOMMERCE_NOSTOCK_LABEL_DEFAULT"				,"Out of Stock");
	...
	define("LOCALE_INFO_DIRECTORY_HEADER"									,"Database");
