...
- Multilanguage support - English, Lithuanian, Russian, German, Dutch, 
  Italian, French, Hebrew, Turkish, Chinese (new!) and Czech (new!) language files included; 
...
- HTML code cleanup (useful for copy/pasting content from MS Word) (new!);
- Optional design time borders on borderless tables (new!);
