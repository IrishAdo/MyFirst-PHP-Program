function launch_menu(home_label, domain_admin, help_label, debug){
	stm_bm(["Libertas_Solutions",500,"","/libertas_images/themes/1x1.gif",0,"","",0,1,showdelay,showdelay,hidedelay,1,0,0,""],this);
		begin(0,0,"Horizontally",0,"p0",1);
			...
			add_entry1(help_label,"","p0i99");
				begin(0,0,"undefined",0,"p99",0,4);
					add_entry("About Us","http://www.libertas-solutions.com/company/index.php", "p99i1", "p0i99");
					add_entry("Help","http://www.libertas-solutions.com/support/index.php", "p99i1", "p0i99");
					add_entry("Contact Us","http://www.libertas-solutions.com/contact-us/index.php", "p99i1", "p0i99");
...
function add_entry1(label_str,url_str,current_id){
	stm_ai(current_id,
		[0,label_str,"","",-1,-1,0,url_str,"_self","","","","","","","",
		"",
		"",
		0 ,0 ,0 ,0 ,0 ,"",1,"#B6BDD2",0,
		"","",3,3,1,1,"#fcfcfc  #cccccc #999999","#0A246A","#333333","#333333","0.9em Verdana","0.9em Verdana"]);
}
